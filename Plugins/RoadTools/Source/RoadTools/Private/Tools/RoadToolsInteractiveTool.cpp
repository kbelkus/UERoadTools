...
#include "RoadToolsInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "URoadToolsInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* URoadToolsInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	URoadToolsInteractiveTool* NewTool = NewObject<URoadToolsInteractiveTool>(SceneState.ToolManager);
...
URoadToolsInteractiveToolProperties::URoadToolsInteractiveToolProperties()
{
...
void URoadToolsInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void URoadToolsInteractiveTool::Setup()
{
	...
	Properties = NewObject<URoadToolsInteractiveToolProperties>(this, "Measurement");
...
void URoadToolsInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit URoadToolsInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void URoadToolsInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void URoadToolsInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit URoadToolsInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void URoadToolsInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void URoadToolsInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void URoadToolsInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void URoadToolsInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
