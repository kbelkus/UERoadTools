...
#include "RoadToolsInteractiveTool.generated.h"


/**
 * Builder for URoadToolsInteractiveTool
 */
UCLASS()
class ROADTOOLS_API URoadToolsInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the URoadToolsInteractiveTool
 */
UCLASS(Transient)
class ROADTOOLS_API URoadToolsInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	URoadToolsInteractiveToolProperties();
...
/**
 * URoadToolsInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class ROADTOOLS_API URoadToolsInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<URoadToolsInteractiveToolProperties> Properties;
