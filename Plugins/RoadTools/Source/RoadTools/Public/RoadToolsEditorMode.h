...
#include "RoadToolsEditorMode.generated.h"
 ...
 */
UCLASS()
class URoadToolsEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_RoadToolsEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	URoadToolsEditorMode();
	virtual ~URoadToolsEditorMode();
